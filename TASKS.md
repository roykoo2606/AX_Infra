...
> **분리 안내(2026-07-28)**: 어반데이터랩 회사 AX 작업(T-20260728-01, T-20260708-06, T-20260707-02 포함)은 `~/Urban_AX/TASKS.md`에서 관리한다. 이 보드는 범용 인프라 작업 전용.
...
| ID | 작업 | 담당 | 완료일 |
|---|---|---|---|
| T-20260728-03 | Urban_AX 독립 루트 분리 (`~/Urban_AX` repo 신설, vault·전달킷·rpb 자동화 이설, Hermes UR 라우팅 전환) | Claude Code | 2026-07-28 |
| T-20260728-02 | Urban_AX 마스터 프로젝트 구조화 (서브 3개 이관, uraxx 채널 개편) | Claude Code | 2026-07-28 |
